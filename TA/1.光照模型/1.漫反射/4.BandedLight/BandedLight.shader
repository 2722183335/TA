	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (V2FData i ) : SV_Target
			{
				...
				float dotResult14 = dot( worldSpaceLightDir , ase_worldNormal );
...
/*ASEBEGIN
Version=18800
0;0;1920;1011;2491.668;805.7725;1;True;False
...
Node;AmplifyShaderEditor.WorldNormalVector;33;-1930.668,-39.77246;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=7913A0E31BC8E7BD72C9BBD9E64F6F57B693F8DE